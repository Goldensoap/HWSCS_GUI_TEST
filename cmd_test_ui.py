...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CMDInput.setGeometry(QtCore.QRect(120, 70, 151, 41))
        ...
        self.SendCMDButton.setGeometry(QtCore.QRect(280, 190, 75, 23))
        ...
        self.SerialPortTypeBox.setGeometry(QtCore.QRect(120, 130, 71, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CMDTypeBox.setItemText(1, _translate("MainWindow", "传感信息"))
        self.CMDTypeBox.setItemText(2, _translate("MainWindow", "节点控制"))
        self.CMDTypeBox.setItemText(3, _translate("MainWindow", "路由信息"))
        self.CMDTypeBox.setItemText(4, _translate("MainWindow", "设备状态"))
        self.CMDTypeBox.setItemText(5, _translate("MainWindow", "网络变更"))
