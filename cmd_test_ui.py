...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.StartDemo = QtWidgets.QPushButton(self.tab_3)
        self.StartDemo.setObjectName("StartDemo")
        self.horizontalLayout_6.addWidget(self.StartDemo)
        self.EndDemo = QtWidgets.QPushButton(self.tab_3)
        self.EndDemo.setObjectName("EndDemo")
        self.horizontalLayout_6.addWidget(self.EndDemo)
        ...
        self.gridLayout_5.addItem(spacerItem, 0, 3, 1, 2)
        ...
        self.SpaceBox = QtWidgets.QComboBox(self.tab_3)
        self.SpaceBox.setObjectName("SpaceBox")
        self.horizontalLayout_5.addWidget(self.SpaceBox)
        self.gridLayout_5.addLayout(self.horizontalLayout_5, 1, 3, 1, 1)
        ...
        self.SpaceItemTree = QtWidgets.QTreeWidget(self.tab_3)
        self.SpaceItemTree.setColumnCount(1)
        self.SpaceItemTree.setObjectName("SpaceItemTree")
        self.gridLayout_5.addWidget(self.SpaceItemTree, 3, 0, 6, 1)
        spacerItem3 = QtWidgets.QSpacerItem(445, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_5.addItem(spacerItem3, 3, 1, 2, 4)
        spacerItem4 = QtWidgets.QSpacerItem(20, 109, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.ClearDemoWindow = QtWidgets.QPushButton(self.tab_3)
        self.ClearDemoWindow.setObjectName("ClearDemoWindow")
        self.verticalLayout.addWidget(self.ClearDemoWindow)
        self.gridLayout_5.addLayout(self.verticalLayout, 6, 1, 1, 1)
        spacerItem5 = QtWidgets.QSpacerItem(20, 199, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_5.addItem(spacerItem5, 7, 1, 1, 1)
        spacerItem6 = QtWidgets.QSpacerItem(445, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_5.addItem(spacerItem6, 8, 1, 1, 4)
        self.graphLayout = QtWidgets.QVBoxLayout()
        self.graphLayout.setObjectName("graphLayout")
        self.gridLayout_5.addLayout(self.graphLayout, 5, 3, 3, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_24.setText(_translate("MainWindow", "使用串口1"))
        self.StartDemo.setText(_translate("MainWindow", "开始演示"))
        self.EndDemo.setText(_translate("MainWindow", "结束演示"))
        self.label_21.setText(_translate("MainWindow", "可选空间"))
        self.label_22.setText(_translate("MainWindow", "工作节点与传感器"))
        self.SpaceItemTree.headerItem().setText(0, _translate("MainWindow", "传感器目录"))
        self.label_23.setText(_translate("MainWindow", "传感器信息"))
        self.ClearDemoWindow.setText(_translate("MainWindow", "清空窗口"))
        ...
        self.label_3.setText(_translate("MainWindow", "综合中心JSON信息"))
        ...
        self.label_8.setText(_translate("MainWindow", "JSON信息解码"))
        ...
        self.label_19.setText(_translate("MainWindow", "综合中心二进制数据"))
        self.label_20.setText(_translate("MainWindow", "综合中心二进制数据解析"))
