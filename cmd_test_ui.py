...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CMDTypeBox.addItem("")
        self.CMDTypeBox.addItem("")
        self.gridLayout_3.addWidget(self.CMDTypeBox, 0, 1, 1, 1)
        self.ACKcheck = QtWidgets.QCheckBox(self.tab)
        self.ACKcheck.setObjectName("ACKcheck")
        self.gridLayout_3.addWidget(self.ACKcheck, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.CMD_Example, 1, 1, 3, 2)
        ...
        self.SerialPortTypeBox.addItem("")
        self.gridLayout_3.addWidget(self.SerialPortTypeBox, 1, 3, 1, 1)
        self.PortName = QtWidgets.QLineEdit(self.tab)
        self.PortName.setObjectName("PortName")
        self.gridLayout_3.addWidget(self.PortName, 1, 4, 1, 2)
        self.label_17 = QtWidgets.QLabel(self.tab)
        self.label_17.setObjectName("label_17")
        self.gridLayout_3.addWidget(self.label_17, 2, 0, 1, 1)
        self.OpenPortButton = QtWidgets.QPushButton(self.tab)
        self.OpenPortButton.setObjectName("OpenPortButton")
        self.gridLayout_3.addWidget(self.OpenPortButton, 2, 3, 1, 1)
        self.ClosePortButton = QtWidgets.QPushButton(self.tab)
        self.ClosePortButton.setObjectName("ClosePortButton")
        self.gridLayout_3.addWidget(self.ClosePortButton, 2, 5, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.tab)
        self.label_3.setObjectName("label_3")
        self.gridLayout_3.addWidget(self.label_3, 3, 3, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.CMDInput, 4, 1, 1, 2)
        self.ACKDisplay = QtWidgets.QTextBrowser(self.tab)
        self.ACKDisplay.setObjectName("ACKDisplay")
        self.gridLayout_3.addWidget(self.ACKDisplay, 4, 3, 2, 3)
        ...
        self.gridLayout_3.addWidget(self.CMDLabelDisplay, 5, 1, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.CRCDisplay, 6, 1, 1, 2)
        self.label_8 = QtWidgets.QLabel(self.tab)
        self.label_8.setObjectName("label_8")
        self.gridLayout_3.addWidget(self.label_8, 6, 3, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.CMDBrowser, 7, 1, 1, 2)
        self.ACKParserWindow = QtWidgets.QTextBrowser(self.tab)
        self.ACKParserWindow.setObjectName("ACKParserWindow")
        self.gridLayout_3.addWidget(self.ACKParserWindow, 7, 3, 2, 3)
        ...
        self.gridLayout_3.addLayout(self.verticalLayout, 8, 0, 2, 2)
        self.CleanOutPutButton = QtWidgets.QPushButton(self.tab)
        self.CleanOutPutButton.setObjectName("CleanOutPutButton")
        self.gridLayout_3.addWidget(self.CleanOutPutButton, 9, 3, 1, 1)
        ...
        self.gridLayout_4.addLayout(self.gridLayout, 0, 0, 4, 2)
        self.label_18 = QtWidgets.QLabel(self.tab_2)
        self.label_18.setObjectName("label_18")
        self.gridLayout_4.addWidget(self.label_18, 0, 2, 1, 1)
        self.OpenPortButton_2 = QtWidgets.QPushButton(self.tab_2)
        self.OpenPortButton_2.setObjectName("OpenPortButton_2")
        self.gridLayout_4.addWidget(self.OpenPortButton_2, 0, 4, 1, 1)
        ...
        self.SerialPortTypeBox_2.addItem("")
        self.gridLayout_4.addWidget(self.SerialPortTypeBox_2, 1, 2, 1, 1)
        self.PortName_2 = QtWidgets.QLineEdit(self.tab_2)
        self.PortName_2.setObjectName("PortName_2")
        self.gridLayout_4.addWidget(self.PortName_2, 1, 3, 1, 1)
        self.ClosePortButton_2 = QtWidgets.QPushButton(self.tab_2)
        self.ClosePortButton_2.setObjectName("ClosePortButton_2")
        self.gridLayout_4.addWidget(self.ClosePortButton_2, 1, 4, 1, 1)
        self.label_19 = QtWidgets.QLabel(self.tab_2)
        self.label_19.setObjectName("label_19")
        self.gridLayout_4.addWidget(self.label_19, 2, 2, 1, 2)
        self.ACKDisplay_2 = QtWidgets.QTextBrowser(self.tab_2)
        self.ACKDisplay_2.setObjectName("ACKDisplay_2")
        self.gridLayout_4.addWidget(self.ACKDisplay_2, 3, 2, 2, 3)
        ...
        self.gridLayout_4.addWidget(self.MsgCRCdisplay, 4, 1, 2, 1)
        self.label_20 = QtWidgets.QLabel(self.tab_2)
        self.label_20.setObjectName("label_20")
        self.gridLayout_4.addWidget(self.label_20, 5, 2, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.MsgflowDisplay, 6, 1, 1, 1)
        self.ACKParserWindow_2 = QtWidgets.QTextBrowser(self.tab_2)
        self.ACKParserWindow_2.setObjectName("ACKParserWindow_2")
        self.gridLayout_4.addWidget(self.ACKParserWindow_2, 6, 2, 2, 3)
        ...
        self.gridLayout_4.addLayout(self.verticalLayout_3, 7, 0, 2, 2)
        self.CleanOutPutButton_2 = QtWidgets.QPushButton(self.tab_2)
        self.CleanOutPutButton_2.setObjectName("CleanOutPutButton_2")
        self.gridLayout_4.addWidget(self.CleanOutPutButton_2, 8, 2, 1, 1)
